        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md mb-6">
            <div class="flex items-center space-x-4">
                <input
                    ...
                    class="flex-grow p-2 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <input
                    ...
                    class="p-2 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
