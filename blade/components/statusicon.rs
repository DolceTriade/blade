...
pub fn StatusIcon(
    ...
    match status.get() {
            ...
            _ => {
                 view! {
                    <div role="status">
                    <svg aria-hidden="true" class={tailwind_merge("text-gray-200 animate-spin dark:text-gray-600 fill-blue-600", &class.get())} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
