...
pub fn Test() -> impl IntoView {
    ...
    let (active_tab, set_active_tab) = signal("results");
                    ...
                    <div class="h-[73dvh] flex items-start justify-start justify-items-center">
                        ...
                        <Card class="h-full w-full max-w-full p-1 m-1 flex-1 overflow-x-auto overflow-auto">
                            ...
                            <div class="border-b border-gray-200 dark:border-gray-600 mb-4">
                                <nav class="flex space-x-8">
                                    <button
                                        ...
                                        on:click=move |_| set_active_tab.set("results")
                                    >
                                        "Results"
                                    </button>
                                    <button
                                        ...
                                        on:click=move |_| set_active_tab.set("insights")
                                    >
                                        "Insights"
                                    </button>
                                </nav>
                            ...
                            {move || match active_tab.get() {
                                "insights" => Either::Left(view! { <TestInsights /> }),
                                _ => {
                                    Either::Right(
                                        view! {
